...
export const TypedError = (id: errorKey, message?: string) => {
...
export const WRONG_PREVIOUS_SESSION_ERROR_MESSAGE: string =
  "wrong previous session";
export const DEVICE_DISCONNECTED_DURING_ACTION: string =
  "device disconnected during action";
export const INVALID_PIN_ERROR_MESSAGE: string = "PIN invalid";
export const WEBUSB_ERROR_MESSAGE: string =
